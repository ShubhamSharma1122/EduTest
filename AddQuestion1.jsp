<%-- 
    Document   : AddQuestion1.jsp
    Created on : 14 Jun, 2024, 2:13:42 PM
    Author     : Shiva
--%>
    ...
    <%
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            try {
                ...
                String sql = "INSERT INTO questionsdsa (question_text, option_a, option_b, option_c, option_d, correct_answer) " +
